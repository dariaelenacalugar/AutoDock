    ...
    <div class="container">
        ...
        <div class="right-panel">
            ...
            <div class="role-selector">
                <a href="create-acc-manager.php" id="btn-manager" class="role-btn" style="text-decoration: none;">
                    <span>Manager</span>
                </a>
                 <div id="btn-user" class="role-btn active">
                    <span>User</span>
                </div>
            </div>

            <form class="register-form" action="register-user.php" method="POST">

                <div class="info-banner">
                    <span class="material-symbols-outlined" style="font-size: 16px;">info</span>
                    As a User, you'll need an invite code from your fleet manager to join an existing fleet.
                </div>
                ...
                <div class="terms-group">
                    <label class="remember-me">
                        <input type="checkbox" name="remember_me" required > I agree with Terms & Conditions and Privacy Policy
                    </label>
                </div>
